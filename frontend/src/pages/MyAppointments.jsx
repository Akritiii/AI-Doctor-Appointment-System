...
const MyAppointments = () => {
  ...
  const handleRazorpayPayment = async (appointmentId, amount) => {
    try {
      ...
      const options = {
        ...
        name: "Docto Appointment",
        description: "Doctor Appointment Booking",
        order_id: order.id,
        handler: async function (response) {
          // 4. On successful payment, verify payment
          try {
            const verifyRes = await axios.post(`${backendUrl}/api/user/verify-razorpay`, {
          ...
          >
            ...
            <div className="flex flex-col gap-2 justify-end text-sm text-center">
              <button
                ...
                onClick={() => handleRazorpayPayment(item._id, item.amount)}
              >
                Pay Online
              </button>
